...
It is a PROVISIONAL hand copy (2026-09-24), adapted from clamp's. The real one is
generated -- the master lists live in the `stoatworks-backend` repo and are pushed
out by `scripts/sync-attributions.py` once the project is registered there.
