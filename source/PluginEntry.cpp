/**
	...
	`CFFGLPluginInfo` that Atrac.cpp registers at static-initialisation time.
	...
	binary: which build it is.
		...
		strings Atrac.bundle/Contents/MacOS/Atrac | grep atrac
*/

extern "C" const char* AtracBuildStamp()
{
	return "atrac " ATRAC_VERSION " built " __DATE__ " " __TIME__;
}
